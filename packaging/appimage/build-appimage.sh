...
install -Dm644 resources/images/ceedee-ripper.png "$APPDIR/${APP}.png"
install -Dm644 resources/images/ceedee-ripper.png "$APPDIR/usr/share/icons/hicolor/256x256/apps/${APP}.png"
